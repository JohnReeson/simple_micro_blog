	    		...
	    		<div class="panel panel-default">
	    			<div class="panel-heading">
  					...
  					<div class="panel-body">
			    		<form action="microblog_publish.action" id="publish_form" method="post">
			    			<div class="form-group">
  								<textarea class="form-control" id="publish_input" rows="5" name="content"></textarea>
							</div>
							...
							<div class="form-group">
  								<input type="submit" id="publish_button" class="btn btn-info"  value="发布" />
							</div>
						</form>
					</div>
				</div>
			...
			<c:if test="${Microblogs.size()==0 }">
					<div class="panel panel-primary">
		  				<div class="panel-heading">提示信息</div>
			  				<div class="panel-body">还没有微博，可以发表或关注他人<br/>
		  				</div>
					</div>
				</c:if>
