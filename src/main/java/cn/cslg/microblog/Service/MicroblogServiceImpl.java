...
public class MicroblogServiceImpl implements MicroblogService {
	...
	public void publish(User user, Microblog microblog) {
		...
		microblog.setSourceuserid(user.getId());
	...
	public Integer forword(Microblog microblog, User user) {
		...
		if (forwardRemarkNow.trim().isEmpty()) {
		...
		microblogTemp.setSourceuserid(microblog.getSourceuserid());
		...
		// 为null，代表转发原创作者的
		if (remarkBefore == null || remarkBefore.equals("")) {
